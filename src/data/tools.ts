...
export const tools = [
  ...
  { id: 'keyboard-shortcut-guide', c: 'developer', n: 'Keyboard Shortcut Guide', d: 'Search, browse, and practice keyboard shortcuts for Windows, Mac, Excel, VS Code, and Chrome.', i: '⌨️', b: '#dbeafe', popular: true },
