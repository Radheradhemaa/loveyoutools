...
export default function Terms() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-16">
      <SEO 
        title="Terms of Service - LoveTools" 
        description="Read our terms of service to understand the rules and regulations for using LoveTools."
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none space-y-6 text-text-secondary">
        ...
        <p>
          By accessing the website at lovetools.io, you are agreeing to be bound by these terms of service, 
        ...
        <p>
          Permission is granted to temporarily use the tools on LoveTools's website for personal, non-commercial transitory viewing only. 
          This is the grant of a license, not a transfer of title, and under this license you may not:
        </p>
        <ul className="list-disc pl-6 space-y-2">
          <li>Modify or copy the materials;</li>
          <li>Use the materials for any commercial purpose, or for any public display (commercial or non-commercial);</li>
          <li>Attempt to decompile or reverse engineer any software contained on LoveTools's website;</li>
        ...
        <p>
          The materials on LoveTools's website are provided on an 'as is' basis. LoveTools makes no warranties, 
        ...
        <p>
          In no event shall LoveTools or its suppliers be liable for any damages (including, without limitation, 
          damages for loss of data or profit, or due to business interruption) arising out of the use or inability 
          to use the materials on LoveTools's website.
        </p>
