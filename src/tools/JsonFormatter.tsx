    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="fg">
          ...
          <textarea
            className="fta min-h-[50vh] lg:min-h-[80vh] text-sm"
        ...
        <div className="fg">
          ...
          {error ? (
            <div className="bg-red-500/10 border border-red-500/20 rounded-[9px] p-4 min-h-[50vh] lg:min-h-[80vh] flex flex-col items-center justify-center text-center">
            ...
            <textarea
              className="fta min-h-[50vh] lg:min-h-[80vh] text-sm bg-bg-secondary cursor-text"
              value={output}
              readOnly
